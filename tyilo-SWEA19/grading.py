...
class Grading(blackboard.grading.Grading):
    ...
    groups_regex = r'Hold DA(3|4) - Gruppe \S+'
    # Regex pattern and replacement text to abbreviate group names
    student_group_display_regex = (r'Hold (\S+) - Gruppe (\S+)', r'\1-\2')
    ...
    attempt_directory_name = '~/SWEA19-attempts/{assignment}/{class_name}-{group}_{id}'
